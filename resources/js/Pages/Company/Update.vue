<template>
    ...
    <h2 class="font-bold text-2xl underline mb-2">Atualizar Empresa</h2>
    <div class="xl:w-200">
            ...
            <div class="relative">
                ...
                >
                    <span
                        ...
                        @click="_copyText($page.props.company.uuid)"
                        >Cópiar</span
                    >
                </div>
            </div>
...
function _loadCompany() {
    ...
    form.activated = Boolean(page.props.company.activated);
    form.systems_useds = page.props.company.systems_useds;
    form.group_company_id = page.props.company.group_company_id;
}
