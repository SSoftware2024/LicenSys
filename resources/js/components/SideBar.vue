<template>
    ...
    <aside
        id="default-sidebar"
        class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full border-r-[0.2px] sm:translate-x-0"
        aria-label="Sidebar"
    >
        <div
    ...
    <div class="px-4 py-2 sm:ml-64">
        <div class="container bg-red-200 m-auto">
            <slot></slot>
        </div>
    </div>
</template>
